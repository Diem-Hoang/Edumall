...
class Post02 extends Component {
    render() {
        return (
            <main className="main" id="top">
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-12">
                                ...
                                <h1 className="mb-6">Học nhanh Guitar 30 ngày</h1>
                            </div>
                        </div>
                    </div>{/* end of .container*/}
                </section>
                ...
                <section style={{ marginTop: '-21.5rem' }}>
                    <div className="container">
                        <div className="row">
                            <div className="col-md-8"><img className="w-100" src="assets/img/gallery/guitar.jpg" alt="..." />
                                <h1 className="my-4">Miêu tả</h1>
                                <p> Giáo trình được xây dựng dựa trên kinh nghiệm giảng dạy và cập nhật theo sát giáo trình thực tế tại lớp đàn Hiển Râu để phù hợp với tất cả mọi người, kể cả những người không có năng khiếu âm nhạc.<br/>Học viên sẽ được hỗ trợ và giải đáp về mặt học thuật liên tục qua Fanpage Hiển Râu Guitar. <br/>Sau khóa học này, học viên sẽ có nền tảng cơ bản vững chắc về guitar cũng như các cách chơi guitar thật hấp dẫn để tiếp tục lên những trình độ cao hơn với các khóa học tiếp theo của Hiển Râu. </p>
                                <h1>Bạn sẽ học gì?</h1>
                                ...
                                <h2 className="font-sans-serif text-primary fw-bold">Hiển Râu</h2>
                                ...
                                <div className="card card-span text-white h-20"><img className="w-30" src="assets/img/gallery/hienrau.jpg" alt="..." />
                                    <div className="card-body px-xl-5 px-md-3 pt-0">
                                        <div className="d-flex flex-column align-items-center bg-100" style={{ marginTop: '-2.4rem' }}>
                                            <h5 className="mt-3 mb-0">Hiển Râu</h5>
                                            <p className="text-muted">Giáo viên âm nhạc</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="card">
                                    <ul className="list-group list-group-flush">
                                        <li className="list-group-item"><strong>01 </strong>: GUITAR ĐỆM HÁT LÀ GÌ?</li>
                                        <li className="list-group-item"><strong>02 </strong>: LÀM QUEN VỚI NHỊP PHÁCH</li>
                                        <li className="list-group-item"><strong>03 </strong>: NHỮNG LƯU Ý CƠ BẢN</li>
                                        <li className="list-group-item"><strong>04 </strong>: HỢP ÂM TRƯỞNG CƠ BẢN</li>
                                        <li className="list-group-item"><strong>05</strong>: HỢP ÂM THỨ CƠ BẢN</li>
                                        <li className="list-group-item"><strong>06 </strong>: 7 HỢP ÂM 7 CƠ BẢN</li>
                                        <li className="list-group-item"><strong>07 </strong>: QUẠT SAO CHO CHUẨN ?</li>
                                    </ul>
                                </div>
                            ...
                            <div className="col-md-4">
                                <div className="card">
                                    <ul className="list-group list-group-flush">
                                        <li className="list-group-item"><strong>Đã đăng kí </strong>: 1500 học viên</li>
                                        <li className="list-group-item"><strong>Thời lượng </strong>: 20 giờ</li>
                                        <li className="list-group-item"><strong>Bài giảng </strong>: 7</li>
                                        <li className="list-group-item"><strong>Danh mục </strong>: Âm nhạc</li>
