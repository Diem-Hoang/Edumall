...
class Post03 extends Component {
    render() {
        return (
            <main className="main" id="top">
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-12">
                                ...
                                <h1 className="mb-6">Nhập môn cơ bản với ReactJS</h1>
                            </div>
                        </div>
                    </div>{/* end of .container*/}
                </section>
                ...
                <section style={{ marginTop: '-21.5rem' }}>
                    <div className="container">
                        <div className="row">
                            <div className="col-md-8"><img className="w-100" src="assets/img/gallery/reactjs.jpg" alt="..." />
                                ...
                                <div className="card card-span text-white h-20"><img className="w-30" src="assets/img/gallery/man3.jpg" alt="..." />
                                ...
                                <div className="card">
                                    <ul className="list-group list-group-flush">
                                        ...
                                        <li className="list-group-item"><strong>06 </strong>: THIẾT KẾ GIAO DIỆN</li>
                                        <li className="list-group-item"><strong>07 </strong>: REDUX</li>
                                    </ul>
                                </div>
                            ...
                            <div className="col-md-4">
                                <div className="card">
                                    <ul className="list-group list-group-flush">
                                        <li className="list-group-item"><strong>Đã đăng kí </strong>: 1340 học viên</li>
