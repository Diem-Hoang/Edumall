...
class Post07 extends Component {
    render() {
        return (
            <main className="main" id="top">
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-12">
                                ...
                                <h1 className="mb-6">Viết lách như bậc thầy văn học</h1>
                            </div>
                        </div>
                    </div>{/* end of .container*/}
                </section>
                ...
                <section style={{ marginTop: '-21.5rem' }}>
                    <div className="container">
                        <div className="row">
                            <div className="col-md-8"><img className="w-100" src="assets/img/gallery/vietlach.jpg" alt="..." />
                                ...
                                <h2 className="font-sans-serif text-primary fw-bold">Cố Nguyệt Sương</h2>
                                ...
                                <div className="card card-span text-white h-20"><img className="w-30" src="assets/img/gallery/woman7.jpg" alt="..." />
                                    <div className="card-body px-xl-5 px-md-3 pt-0">
                                        <div className="d-flex flex-column align-items-center bg-100" style={{ marginTop: '-2.4rem' }}>
                                            <h5 className="mt-3 mb-0">Cố Nguyệt Sương</h5>
