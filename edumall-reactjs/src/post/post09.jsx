...
class Post09 extends Component {
    render() {
        return (
            <main className="main" id="top">
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-12">
                                ...
                                <h1 className="mb-6">Nghệ thuật và Thiết kế đồ họa</h1>
                            </div>
                        </div>
                    </div>{/* end of .container*/}
                </section>
                ...
                <section style={{ marginTop: '-21.5rem' }}>
                    <div className="container">
                        <div className="row">
                            <div className="col-md-8"><img className="w-100" src="assets/img/gallery/dohoa.jpg" alt="..." />
                                ...
                                <h2 className="font-sans-serif text-primary fw-bold">Trần Văn C</h2>
                                ...
                                <div className="card card-span text-white h-20"><img className="w-30" src="assets/img/gallery/man9.jpg" alt="..." />
                                    <div className="card-body px-xl-5 px-md-3 pt-0">
                                        <div className="d-flex flex-column align-items-center bg-100" style={{ marginTop: '-2.4rem' }}>
                                            <h5 className="mt-3 mb-0">Trần Văn C</h5>
                                ...
                                <div className="card">
                                    <ul className="list-group list-group-flush">
                                        ...
                                        <li className="list-group-item"><strong>02 </strong>: CÀI ĐẶT MÔI TRƯỜNG</li>
                                        <li className="list-group-item"><strong>03 </strong>: CƠ BẢN VỀ HTML/CSS</li>
                                        <li className="list-group-item"><strong>04 </strong>: COMPONENT</li>
                                        <li className="list-group-item"><strong>05</strong>: KẾT NỐI CƠ SỞ DỮ LIỆU VỚI FIREBASE</li>
                                    </ul>
                                </div>
                            ...
                            <div className="col-md-4">
                                <div className="card">
                                    <ul className="list-group list-group-flush">
                                        <li className="list-group-item"><strong>Đã đăng kí </strong>: 1390 học viên</li>
                                        <li className="list-group-item"><strong>Thời lượng </strong>: 87 giờ</li>
                                        <li className="list-group-item"><strong>Bài giảng </strong>: 5</li>
                                        <li className="list-group-item"><strong>Danh mục </strong>: Marketing</li>
