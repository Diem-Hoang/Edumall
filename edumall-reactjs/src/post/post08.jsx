...
class Post08 extends Component {
    render() {
        return (
            <main className="main" id="top">
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-12">
                                ...
                                <h1 className="mb-6">Introduction to Logic and Critical Thinking</h1>
                            </div>
                        </div>
                    </div>{/* end of .container*/}
                </section>
                ...
                <section style={{ marginTop: '-21.5rem' }}>
                    <div className="container">
                        <div className="row">
                            <div className="col-md-8"><img className="w-100" src="assets/img/gallery/thinking.jpg" alt="..." />
                                ...
                                <h2 className="font-sans-serif text-primary fw-bold">Phạm Văn D</h2>
                                ...
                                <div className="card card-span text-white h-20"><img className="w-30" src="assets/img/gallery/man8.jpg" alt="..." />
                                    <div className="card-body px-xl-5 px-md-3 pt-0">
                                        <div className="d-flex flex-column align-items-center bg-100" style={{ marginTop: '-2.4rem' }}>
                                            <h5 className="mt-3 mb-0">Phạm Văn D</h5>
                                ...
                                <div className="card">
                                    <ul className="list-group list-group-flush">
                                        ...
                                        <li className="list-group-item"><strong>02 </strong>: KHÁI NIỆM CHUNG</li>
                                        <li className="list-group-item"><strong>03 </strong>: TÌM HIỂU</li>
                                        <li className="list-group-item"><strong>04 </strong>: TÌM HIỂU VẤN ĐỀ</li>
                                        <li className="list-group-item"><strong>05</strong>: LẬT NGƯỢC VẤN ĐỀ</li>
                                        <li className="list-group-item"><strong>06 </strong>: SUY NGHĨ TÍCH CỰC</li>
                            ...
                            <div className="col-md-4">
                                <div className="card">
                                    <ul className="list-group list-group-flush">
                                        <li className="list-group-item"><strong>Đã đăng kí </strong>: 1470 học viên</li>
                                        <li className="list-group-item"><strong>Thời lượng </strong>: 120 giờ</li>
                                        <li className="list-group-item"><strong>Bài giảng </strong>: 7</li>
                                        <li className="list-group-item"><strong>Danh mục </strong>: Nghệ thuật - Đời sống</li>
                                        <li className="list-group-item"><strong>Trình độ</strong>: Cấp độ 3</li>
