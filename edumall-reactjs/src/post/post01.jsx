...
class Post01 extends Component {
    render() {
        return (
                            ...
                            <div className="col-md-8"><img className="w-100" src="assets/img/gallery/mmt.png" alt="..." />
                                ...
                                <div className="card card-span text-white h-20"><img className="w-30" src="assets/img/gallery/man1.jpg" alt="..." />
                                    <div className="card-body px-xl-5 px-md-3 pt-0">
                                        <div className="d-flex flex-column align-items-center bg-100" style={{ marginTop: '-2.4rem' }}>
                                            <h5 className="mt-3 mb-0">Trần Văn A</h5>
                                            <p className="text-muted">Giảng viên CNTT</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="card">
                                    <ul className="list-group list-group-flush">
                                        ...
                                        <li className="list-group-item"><strong>02 </strong>: TẦNG ỨNG DỤNG</li>
                                        <li className="list-group-item"><strong>03 </strong>: TẦNG GIAO VẬN</li>
                                        <li className="list-group-item"><strong>04 </strong>: TẦNG MẠNG</li>
                                        <li className="list-group-item"><strong>05</strong>: TẦNG LIÊN KẾT DỮ LIỆU</li>
                                        <li className="list-group-item"><strong>06 </strong>: MẠNG KHÔNG DÂY</li>
                                        <li className="list-group-item"><strong>07 </strong>: MẠNG MANET</li>
                                        <li className="list-group-item"><strong>08 </strong>: TCP/IP NETWORK ADMINISTRATION</li>
                                        <li className="list-group-item"><strong>09 </strong>: HTTP BASICS</li>
                                        <li className="list-group-item"><strong>10</strong>: DNS & BIND SERVICES</li>
                            ...
                            <div className="col-md-4">
                                <div className="card">
                                    <ul className="list-group list-group-flush">
                                        ...
                                        <li className="list-group-item"><strong>Bài giảng </strong>: 10</li>
                                        <li className="list-group-item"><strong>Danh mục </strong>: Lập trình CNTT</li>
                                        <li className="list-group-item"><strong>Trình độ</strong>: Cấp độ 2</li>
