                                ...
                                <div className="card mb-5 mb-md-0 h-100">
                                    ...
                                    <div className="card-body px-4 py-6 py-md-5 py-lg-6">
                                        ...
                                        <ul className="list-unstyled">
                                            <li className="mb-3"><i className="fas fa-check text-info me-2" />Tham gia 6 khóa học</li>
                                        ...
                                        <div className="d-grid"> <a className="btn btn-lg btn-primary" href="/combo1">Mua ngay</a></div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-4">
                                <div className="card mb-5 mb-md-0 h-100">
                                    ...
                                    <div className="card-body px-4 py-6 py-md-5 py-lg-6">
                                        <div className="d-flex justify-content-start text-secondary"><span className="display-3 fw-medium">1.000.000</span><span className="display-4 fw-medium">VNĐ</span></div>
                                        <p className="text-muted mb-2 my-md-3">Giới hạn tư nhân là phổ biến nhất</p>
                                        <hr className="border border-1" />
                                        <ul className="list-unstyled">
                                            <li className="mb-3"><i className="fas fa-check text-info me-2" />Tham gia 8 khóa học</li>
                                            <li className="mb-3"><i className="fas fa-check text-info me-2" />Thảo luận về khóa học</li>
                                            <li className="mb-3"><i className="fas fa-check text-info me-2" />Chứng chỉ sau khi hoàn thành</li>
                                            <li className="mb-3"><i className="fas fa-check text-info me-2" />Xem ngoại tuyến</li>
                                            <li className="mb-3"><i className="fas fa-check text-muted me-2" /> Phiên riêng tư</li>
                                        </ul>
                                        <div className="d-grid"><a className="btn btn-lg btn-secondary" href="/combo2">Mua ngay</a></div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-4">
                                <div className="card mb-5 mb-md-0 h-100">
                                    ...
                                    <div className="card-body px-4 py-6 py-md-5 py-lg-6">
                                        <div className="d-flex justify-content-start text-secondary"><span className="display-3 fw-medium">2.000.000</span><span className="display-4 fw-medium">VNĐ</span></div>
                                        <p className="text-muted mb-2 my-md-3">Giới hạn tư nhân là phổ biến nhất</p>
                                        <hr className="border border-1" />
                                        <ul className="list-unstyled">
                                            <li className="mb-3"><i className="fas fa-check text-info me-2" />Tham gia 12 khóa học</li>
                                            <li className="mb-3"><i className="fas fa-check text-info me-2" />Thảo luận về khóa học</li>
                                            <li className="mb-3"><i className="fas fa-check text-info me-2" />Chứng chỉ sau khi hoàn thành</li>
                                            <li className="mb-3"><i className="fas fa-check text-info me-2" />Xem ngoại tuyến</li>
                                            <li className="mb-3"><i className="fas fa-check text-info me-2" /> Phiên riêng tư</li>
                                        </ul>
                                        <div className="d-grid"> <a className="btn btn-lg btn-primary" href="/combo3">Mua ngay</a></div>
                                    </div>
                                </div>
                            </div> 
                        </div>
