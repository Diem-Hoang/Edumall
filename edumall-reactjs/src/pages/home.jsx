            ...
            <main className="main" id="top">
                    ...
                    <div className="container">
                        <div className="row align-items-center">
                            ...
                            <div className="col-md-7 col-lg-6 text-md-start text-center py-6">
                                ...
                                <h1 className="fs-6 fs-xl-7 mb-5">Học guitar đệm hát cấp tốc trong vòng 30 ngày</h1><a className="btn btn-primary me-2" href="/mua" role="button">Đăng kí ngay</a><a className="btn btn-outline-secondary" href="/post02" role="button">Xem chi tiết</a>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="pt-0">
                    <div className="container">
                        ...
                        <h1 className="text-center my-5">Học viên nói gì về Edumall<br /><span className="text-primary">Bình luận</span></h1>
