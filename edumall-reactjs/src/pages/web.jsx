                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-12">
                                <h5 className="font-sans-serif text-primary fw-bold">Tìm những chủ đề mà bạn yêu thích</h5>
                                <h6 className="font-sans-serif text-primary fw-bold">Có hơn 2000 khoá học với 12 ngành khác nhau để bạn có thể lựa chọn</h6>
                                <h1 className="mb-6">Danh mục</h1>
                                <form className="row g-3">
                                    <div className="col-sm-6 col-md-3">
                                        ...
                                        <select className="form-select" id="inputCategories">
                                            ...
                                            <option value={2}>Nghệ thuật - Đời sống</option>
                                            <option value={3}>Phát triển bản thân</option>
                                            <option value={4}>Kinh doanh - Khởi nghiệp</option>
                                            <option value={5}>Thể thao - Sức khỏe</option>
                                            <option value={6}>Hôn nhân - Gia đình</option>
                                            <option value={7}>Thiết kế</option>
                                            <option value={8}>Lập trình CNTT</option>
                                            <option value={9}>Marketing</option>
                                            <option value={10}>Tin học văn phòng</option>
                                            <option value={11}>Âm nhạc</option>
                                        </select>
                                    </div>
                                    <div className="col-sm-6 col-md-3">
                                    ...
                                    <div className="col-sm-6 col-md-3">
                                        ...
                                        <select className="form-select" id="inputInstructor">
                                            ...
                                            <option value={1}>Trần Văn A</option>
                                            <option value={2}>Nguyễn Thị B</option>
                                            <option value={3}>Huỳnh Văn C</option>
                                            <option value={4}>Phạm Thu D</option>
                                            <option value={5}>Trần Thị E</option>
                                        </select>
                                    </div>
                        ...
                        <div className="col-md-4 mb-4">
                            ...
                            <div className="col-md-4 mb-4">
                                <div className="card h-100"><img className="card-img-top w-100" src="assets/img/gallery/nhat.png" alt="courses" />
                                    <div className="card-body">
                                        <h5 className="font-sans-serif fw-bold fs-md-0 fs-lg-1">Cùng lấy N3 với Somatome nào!</h5><a className="text-muted fs--1 stretched-link text-decoration-none" href="/post04">JPan Kosei</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-md-4 mb-4">
                                <div className="card h-100"><img className="card-img-top w-100" src="assets/img/gallery/design.png" alt="courses" />
                                    <div className="card-body">
                                        <h5 className="font-sans-serif fw-bold fs-md-0 fs-lg-1">Thiết kế hệ thống thông tin cho người mới bắt đầu</h5><a className="text-muted fs--1 stretched-link text-decoration-none" href="/post05">The Museum of Modern Art</a>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-4 mb-4">
                                <div className="card h-100"><img className="card-img-top w-100" src="assets/img/gallery/psychology.png" alt="courses" />
                                    <div className="card-body">
                                        <h5 className="font-sans-serif fw-bold fs-md-0 fs-lg-1">Phật giáo và tâm lý học</h5><a className="text-muted fs--1 stretched-link text-decoration-none" href="/post06">The Museum of Modern Art</a>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-4 mb-4">
                                <div className="card h-100"><img className="card-img-top w-100" src="assets/img/gallery/philosophy.png" alt="courses" />
                                    <div className="card-body">
                                        <h5 className="font-sans-serif fw-bold fs-md-0 fs-lg-1">Giới thiệu về triết học</h5><a className="text-muted fs--1 stretched-link text-decoration-none" href="/post07">Duke University</a>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-4 mb-4">
                                <div className="card h-100"><img className="card-img-top w-100" src="assets/img/gallery/arguments.png" alt="courses" />
                                    <div className="card-body">
                                        <h5 className="font-sans-serif fw-bold fs-md-0 fs-lg-1">Làm sao để nhìn nhận vấn đề thực tiễn hơn</h5><a className="text-muted fs--1 stretched-link text-decoration-none" href="/post05">The Museum of Modern Art</a>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-4 mb-4">
                                <div className="card h-100"><img className="card-img-top w-100" src="assets/img/gallery/experience-design.png" alt="courses" />
                                    <div className="card-body">
                                        <h5 className="font-sans-serif fw-bold fs-md-0 fs-lg-1">Cách tạo thời gian biểu cho chính mình</h5><a className="text-muted fs--1 stretched-link text-decoration-none" href="/post06">The Museum of Modern Art</a>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-4 mb-4">
                                <div className="card h-100"><img className="card-img-top w-100" src="assets/img/gallery/user-design.png" alt="courses" />
                                    <div className="card-body">
                                        <h5 className="font-sans-serif fw-bold fs-md-0 fs-lg-1">Viết lách như bậc thầy văn học</h5><a className="text-muted fs--1 stretched-link text-decoration-none" href="/post07">The Museum of Modern Art</a>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-4 mb-4">
                                <div className="card h-100"><img className="card-img-top w-100" src="assets/img/gallery/art-design.png" alt="courses" />
                                    <div className="card-body">
                                        <h5 className="font-sans-serif fw-bold fs-md-0 fs-lg-1">Nghệ thuật và Thiết kế đồ họa</h5><a className="text-muted fs--1 stretched-link text-decoration-none" href="/post09">The Museum of Modern Art</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-md-4 mb-4">
                                <div className="card h-100"><img className="card-img-top w-100" src="assets/img/gallery/photographs.png" alt="courses" />
                                    <div className="card-body">
                                        <h5 className="font-sans-serif fw-bold fs-md-0 fs-lg-1">Nâng cao khả năng phân tích ảnh</h5><a className="text-muted fs--1 stretched-link text-decoration-none" href="/post09">Duke University</a>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-4 mb-4">
                                <div className="card h-100"><img className="card-img-top w-100" src="assets/img/gallery/design.png" alt="courses" />
                                    <div className="card-body">
                                        <h5 className="font-sans-serif fw-bold fs-md-0 fs-lg-1">Thiết kế hệ thống thông tin cho người mới bắt đầu</h5><a className="text-muted fs--1 stretched-link text-decoration-none" href="/post01">The Museum of Modern Art</a>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-4 mb-4">
                                <div className="card h-100"><img className="card-img-top w-100" src="assets/img/gallery/critical-thinking.png" alt="courses" />
                                    <div className="card-body">
                                        <h5 className="font-sans-serif fw-bold fs-md-0 fs-lg-1">Introduction to Logic and Critical Thinking</h5><a className="text-muted fs--1 stretched-link text-decoration-none" href="/post08">Duke University</a>
                                    </div>
                                </div>
                            </div>
